...
const Navbar = () => {
  return (
   // <header className="w-full h-28  py-8 border-b-[1px] border-gray-500 flex justify-between items-center text-black px-8 ">
          <div className=" w-full h-20  py-8 border-b-[4px] border-rose-400 flex justify-between items-center text-black px-8 bg-white shadow-slate-500">
            ...
            <nav className="basis-1/2  flex items-center justify-center font-medium text-gray-800 ">
                ...
                <Link href="/newsCard" className="mr-4 hover:text-rose-500 focus:text-red-700">Foreign</Link>
